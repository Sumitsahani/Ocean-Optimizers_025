...
function InvoiceModal({ showModal, closeModal, info }) {
  const { 
      currency, 
      total, 
      items, 
  ...
  // State to manage Paid/Unpaid status
        ...
        <div id="invoiceCapture">
          <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
            ...
            <div className="text-end ms-4">
              ...
              {/* Dropdown to select Paid/Unpaid status */}
              <div className="mt-2">
                <label htmlFor="invoiceStatus"><strong>Status: </strong></label>
                <select 
                  id="invoiceStatus" 
                  value={status} 
