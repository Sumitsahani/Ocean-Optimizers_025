...
import { Billing, Business, CardDeal, CTA, Footer, Hero, Navbar, Stats, Testimonials } from "./components";
      ...
      <div style={loaderStyles}>
        <div>
          {icons.map((icon, index) => (
            <span
              key={index}
              style={index === visibleIconIndex ? visibleIconStyle : iconStyles} // Apply visibility styles
            >
              {icon}
            </span>
          ))}
